...
from enmapboxprocessing.algorithm.fitlgbmclassifieralgorithm import FitLGBMClassifierAlgorithm
...
from enmapboxprocessing.algorithm.fitsvrpolyalgorithm import FitSvrPolyAlgorithm
from enmapboxprocessing.algorithm.fitsvrrbfalgorithm import FitSvrRbfAlgorithm
from enmapboxprocessing.algorithm.fitxgbclassifieralgorithm import FitXGBClassifierAlgorithm
from enmapboxprocessing.algorithm.fitxgbregressoralgorithm import FitXGBRegressorAlgorithm
from enmapboxprocessing.algorithm.fitxgbrfclassifieralgorithm import FitXGBRFClassifierAlgorithm
from enmapboxprocessing.algorithm.fitxgbrfregressoralgorithm import FitXGBRFRegressorAlgorithm
...
def algorithms():
    algos = [
        ...
        FitSvrRbfAlgorithm(),
        FitSvrPolyAlgorithm(),
        FitXGBClassifierAlgorithm(),
        FitXGBRFClassifierAlgorithm(),
        FitXGBRegressorAlgorithm(),
        FitXGBRFRegressorAlgorithm(),
        FitLGBMClassifierAlgorithm(),
        FitLGBMRegressorAlgorithm(),
        FitCatBoostClassifierAlgorithm(),
        FitCatBoostRegressorAlgorithm(),
        ...
        PredictClusteringAlgorithm(),
        PredictRegressionAlgorithm(),
        PrepareClassificationDatasetFromFilesAlgorithm(),
        PrepareClassificationDatasetFromCategorizedRasterAlgorithm(),
        PrepareClassificationDatasetFromCategorizedVectorAlgorithm(),
        PrepareClassificationDatasetFromTableAlgorithm(),
